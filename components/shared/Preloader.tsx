  ...
  return (
    <div
      ...
      style={{
        ...
        transition: done ? 'transform 1s 0.1s cubic-bezier(.16,1,.3,1)' : 'none',
      }}
    >
      <div
        ref={barRef}
      ...
      />
      <div style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '.2em', textTransform: 'uppercase', color: '#7a7772', marginBottom: '1rem' }}>
        Loading
      </div>
      <div
        ref={numRef}
